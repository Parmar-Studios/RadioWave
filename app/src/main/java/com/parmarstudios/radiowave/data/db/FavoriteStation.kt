...
/**
 * Entity representing a favorite radio station in the local Room database.
 *
...
data class FavoriteStation(
    ...
    companion object {
        /**
         * Creates a [FavoriteStation] from a [RadioStation] instance.
         *
         * @param station The [RadioStation] to convert.
         * @return A new [FavoriteStation] with copied properties.
         */
        fun fromRadioStation(station: RadioStation): FavoriteStation = FavoriteStation(
...
/**
 * Extension function to convert a [FavoriteStation] back to a [RadioStation].
 *
 * @receiver The [FavoriteStation] instance.
 * @return A [RadioStation] with copied properties.
 */
fun FavoriteStation.toRadioStation(): RadioStation = RadioStation(
