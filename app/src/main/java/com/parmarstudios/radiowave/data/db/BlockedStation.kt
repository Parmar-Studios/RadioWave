...
/**
 * Entity representing a blocked radio station in the local Room database.
 *
 * @property stationUuid Unique identifier for the station (primary key).
 ...
 */
@Entity(tableName = "blocked_stations")
data class BlockedStation(
    @PrimaryKey val stationUuid: String, // Unique station ID
    ...
    companion object {
        /**
         * Creates a [BlockedStation] from a [RadioStation] instance.
         *
         * @param station The [RadioStation] to convert.
         * @return A new [BlockedStation] with copied properties.
         */
        fun fromRadioStation(station: RadioStation): BlockedStation = BlockedStation(
...
/**
 * Extension function to convert a [BlockedStation] back to a [RadioStation].
 *
 * @receiver The [BlockedStation] instance.
 * @return A [RadioStation] with copied properties.
 */
fun BlockedStation.toRadioStation(): RadioStation = RadioStation(
